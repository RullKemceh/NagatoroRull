let handler = async (m, { conn, args }) => {
  ...
  await conn.sendButton(m.chat, `*PREMIUM LIST*
┌✦ *My Premium Time:*
┊• *Name:* ${conn.getName(m.sender)}
${prem ? `${clockString (premiumTime - new Date() * 1)}` : '┊• *PremiumTime:* No Prem'}
┗━═┅═━––––––๑
...
┗━═┅═━––––––๑`.trim(), author, null, [[`${prem ? '𝑶𝒘𝒏𝒆𝒓 𝑹𝒖𝒍𝒍𝑩𝒐𝒕': '𝑩𝒆𝒍𝒊 𝑷𝒓𝒆𝒎𝒊𝒖𝒎'}`, `${prem ? '.owner nomor': '.premium'}`]], fkon)
setTimeout(() => {
